    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          InformationFields(
              type: "field", text: context.loc.oldPassword , controller: oldPassword),
          InformationFields(type: "name", text: context.loc.newPassword),
          InformationFields(
              type: "field", text: context.loc.newPassword , controller: newPassword),
          ...
          buttonLogin(context.loc.changePassword, Colors.grey, 200, 50,
            ...
            if (oldPassword.text == '') {
              ...
              if (!checkPassword(newPassword.text)) {
                Fluttertoast.showToast(
                  msg:
                      context.loc.pleaseRightNewPass,
                  toastLength: Toast.LENGTH_LONG,
                  gravity: ToastGravity.CENTER,
                  timeInSecForIosWeb: 1,
                  backgroundColor: const Color(0xff193d3d),
