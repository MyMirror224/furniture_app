    ...
    return Material(
      ...
      child: InkWell(
        onTap: () async {
          ...
          //     context,
          //     PageTransition(
          //         //pagetranstion là dùng để chuyển trang mà không cần phải pop ra khỏi trang hiện tại và push vào trang mới như cách thông thường
          //         type: PageTransitionType
          //             .rightToLeftWithFade, // kiểu chuyển trang từ phải qua trái với hiệu ứng fade
          //         child: CollectionPage(futureProductsSearching(value)), // trang chi tieest sp cần tìm kiếm
          //         childCurrent: context.widget));

          // //achieve the result of
          // await SharedPreferencesObject().saveSearchingHistory(value);
          // cơ bản là chuyển trang chi tiết sp và lưu lại lịch sử tìm kiếm
        },
        child: Container(
